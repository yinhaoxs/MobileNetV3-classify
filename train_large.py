...
pretrained_dict = torch.load("./pretrained/mobilenetv3-large-657e7b3d.pth")
# 1.2 load parallel_mode
model = mobilenetv3_large(num_classes=2).cuda()
...
for epoch in range(100):
        ...
        if eval_acc > best_acc:
                best_acc = eval_acc
                save_checkpoint(model, "large_best_model.pth")
